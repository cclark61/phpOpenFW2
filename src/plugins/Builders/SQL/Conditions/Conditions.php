...
trait Conditions
{
    ...
    {
        return self::Condition($field, '=', $value, $params, $type);
    }
    ...
    {
        return self::AndOr('and', self::Condition($field, '=', $value, $params, $type));
    }
    public static function OrEquals(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('or', self::Condition($field, '=', $value, $params, $type));
    }
    ...
    {
        return self::Condition($field, 'LIKE', $value, $params, $type);
    }
    public static function AndLike(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('and', self::Condition($field, 'LIKE', $value, $params, $type));
    }
    public static function OrLike(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('or', self::Condition($field, 'LIKE', $value, $params, $type));
    }
    ...
    {
        return self::Condition($field, 'NOT LIKE', $value, $params, $type);
    }
    public static function AndNotLike(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('and', self::Condition($field, 'NOT LIKE', $value, $params, $type));
    }
    public static function OrNotLike(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('or', self::Condition($field, 'NOT LIKE', $value, $params, $type));
    }
    ...
    {
        return self::Condition($field, 'IN', $value, $params, $type);
    }
    public static function AndIn(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('and', self::Condition($field, 'IN', $value, $params, $type));
    }
    public static function OrIn(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('or', self::Condition($field, 'IN', $value, $params, $type));
    }
    ...
    {
        return self::Condition($field, 'NOT IN', $value, $params, $type);
    }
    public static function AndNotIn(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('and', self::Condition($field, 'NOT IN', $value, $params, $type));
    }
    public static function OrNotIn(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('or', self::Condition($field, 'NOT IN', $value, $params, $type));
    }
    ...
    {
        return self::BetweenCondition($field, 'BETWEEN', $value, $params, $type);
    }
    public static function AndBetween(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('and', self::BetweenCondition($field, 'BETWEEN', $value, $params, $type));
    }
    public static function OrBetween(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('or', self::BetweenCondition($field, 'BETWEEN', $value, $params, $type));
    }
    ...
    {
        return self::BetweenCondition($field, 'NOT BETWEEN', $value, $params, $type);
    }
    public static function AndNotBetween(String $field, $value, Array &$params, String $type='s')
    {
        return self::AndOr('and', self::BetweenCondition($field, 'NOT BETWEEN', $value, $params, $type));
    }
